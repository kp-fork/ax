...
const file_proto_ax_proto_rawDesc = "" +
	...
	"\x06inputs\x18\x04 \x03(\v2\x0e.proto.ContentR\x06inputs\"\\\n" +
	"\fExecResponse\x12(\n" +
	"\aoutputs\x18\x01 \x03(\v2\x0e.proto.ContentR\aoutputs\x12\"\n" +
	"\x05state\x18\x02 \x01(\x0e2\f.proto.StateR\x05state\"i\n" +
...
var file_proto_ax_proto_depIdxs = []int32{
	...
	0,  // 20: proto.ExecResponse.state:type_name -> proto.State
	22, // 21: proto.RegisterAgentRequest.metadata:type_name -> proto.RegisterAgentRequest.MetadataEntry
	18, // 22: proto.RegisterAgentRequest.remote:type_name -> proto.RemoteAgentConfig
	26, // 23: proto.GeminiConfig.timeout:type_name -> google.protobuf.Duration
	3,  // 24: proto.AgentService.Connect:input_type -> proto.AgentMessage
	12, // 25: proto.AgentService.HealthCheck:input_type -> proto.HealthCheckRequest
	14, // 26: proto.AXService.Exec:input_type -> proto.ExecRequest
	16, // 27: proto.AXService.Fork:input_type -> proto.ForkRequest
	19, // 28: proto.AXService.RegisterAgent:input_type -> proto.RegisterAgentRequest
	3,  // 29: proto.AgentService.Connect:output_type -> proto.AgentMessage
	13, // 30: proto.AgentService.HealthCheck:output_type -> proto.HealthCheckResponse
	15, // 31: proto.AXService.Exec:output_type -> proto.ExecResponse
	17, // 32: proto.AXService.Fork:output_type -> proto.ForkResponse
	20, // 33: proto.AXService.RegisterAgent:output_type -> proto.RegisterAgentResponse
