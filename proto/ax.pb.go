...
const file_proto_ax_proto_rawDesc = "" +
	"\n" +
	"\x0eproto/ax.proto\x12\x02ax\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x13proto/content.proto\"s\n" +
	"\n" +
	"AgentStart\x12\x19\n" +
...
var file_proto_ax_proto_depIdxs = []int32{
	...
	24, // 11: ax.ExecutionEvent.timestamp:type_name -> google.protobuf.Timestamp
	5,  // 12: ax.ExecRequest.inputs:type_name -> ax.Message
	5,  // 13: ax.ExecResponse.outputs:type_name -> ax.Message
	22, // 14: ax.RegisterAgentRequest.metadata:type_name -> ax.RegisterAgentRequest.MetadataEntry
	12, // 15: ax.RegisterAgentRequest.remote:type_name -> ax.RemoteAgentConfig
	6,  // 16: ax.ListResponse.events:type_name -> ax.ConversationEvent
	25, // 17: ax.GeminiConfig.timeout:type_name -> google.protobuf.Duration
	4,  // 18: ax.AgentService.Connect:input_type -> ax.AgentMessage
	8,  // 19: ax.AgentService.HealthCheck:input_type -> ax.HealthCheckRequest
	10, // 20: ax.ControllerService.Exec:input_type -> ax.ExecRequest
	13, // 21: ax.ControllerService.RegisterAgent:input_type -> ax.RegisterAgentRequest
	15, // 22: ax.EventLogService.List:input_type -> ax.ListRequest
	17, // 23: ax.EventLogService.Delete:input_type -> ax.DeleteRequest
	19, // 24: ax.EventLogService.Fork:input_type -> ax.ForkRequest
	4,  // 25: ax.AgentService.Connect:output_type -> ax.AgentMessage
	9,  // 26: ax.AgentService.HealthCheck:output_type -> ax.HealthCheckResponse
	11, // 27: ax.ControllerService.Exec:output_type -> ax.ExecResponse
	14, // 28: ax.ControllerService.RegisterAgent:output_type -> ax.RegisterAgentResponse
	16, // 29: ax.EventLogService.List:output_type -> ax.ListResponse
	18, // 30: ax.EventLogService.Delete:output_type -> ax.DeleteResponse
	20, // 31: ax.EventLogService.Fork:output_type -> ax.ForkResponse
