...
var file_proto_ax_proto_depIdxs = []int32{
	...
	21, // 14: ax.RegisterAgentRequest.metadata:type_name -> ax.RegisterAgentRequest.MetadataEntry
	...
	4,  // 17: ax.AgentService.Connect:input_type -> ax.AgentMessage
	8,  // 18: ax.AgentService.HealthCheck:input_type -> ax.HealthCheckRequest
	10, // 19: ax.ControllerService.Exec:input_type -> ax.ExecRequest
	13, // 20: ax.ControllerService.RegisterAgent:input_type -> ax.RegisterAgentRequest
	15, // 21: ax.EventLogService.List:input_type -> ax.ListRequest
	17, // 22: ax.EventLogService.Delete:input_type -> ax.DeleteRequest
	19, // 23: ax.EventLogService.Fork:input_type -> ax.ForkRequest
	4,  // 24: ax.AgentService.Connect:output_type -> ax.AgentMessage
	9,  // 25: ax.AgentService.HealthCheck:output_type -> ax.HealthCheckResponse
	11, // 26: ax.ControllerService.Exec:output_type -> ax.ExecResponse
	14, // 27: ax.ControllerService.RegisterAgent:output_type -> ax.RegisterAgentResponse
	16, // 28: ax.EventLogService.List:output_type -> ax.ListResponse
	18, // 29: ax.EventLogService.Delete:output_type -> ax.DeleteResponse
	20, // 30: ax.EventLogService.Fork:output_type -> ax.ForkResponse
