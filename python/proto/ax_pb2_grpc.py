...
class AgentService(object):
    ...
    def Connect(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/ax.AgentService/Connect',
    ...
    def HealthCheck(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ax.AgentService/HealthCheck',
